...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    ...
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">1</div>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    ...
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">2</div>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    ...
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">3</div>
    <abbr class="badge">LAK</abbr>
  </div>
  <div class="col-sm-9" style="position: relative; padding-right: 15px; padding-left: 20px;">
...
<li>
  <div class="pub-row">
    <div class="col-sm-3 abbr position-relative" style="padding: 0 15px;">
      ...
      <!-- 徽章 -->
      <abbr class="badge" style="position:absolute; top:5px; right:5px;">LAK</abbr>
    </div>
    <div class="col-sm-9" style="padding-left:20px;">
      <div class="title">
        <a href="#">Creating artificial students that never existed: Leveraging large language models and CTGANs for synthetic data generation</a>
      </div>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    <img src="/assets/img/bjet 2.png" class="teaser img-fluid z-depth-1" style="width:100%; height:60%; object-fit: cover;">
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">7</div>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    ...
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">8</div>
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    ...
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">9</div>
    <abbr class="badge">BJET</abbr>
  </div>
  <div class="col-sm-9" style="position: relative; padding-right: 15px; padding-left: 20px;">
...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative; padding-right: 15px; padding-left: 15px;">
    <img src="/assets/img/bjet.png" class="teaser img-fluid z-depth-1" style="width:100%; height:60%; object-fit: cover;">
    <div style="position:absolute; top:5px; left:5px; background-color:rgba(0,0,0,0.6); color:#fff; font-size:12px; padding:2px 5px; border-radius:3px;">10</div>
    <abbr class="badge">BJET</abbr>
  </div>
  <div class="col-sm-9" style="position: relative; padding-right: 15px; padding-left: 20px;">
